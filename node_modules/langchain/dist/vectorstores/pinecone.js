...
export class PineconeStore extends VectorStore {
    ...
    static async fromTexts(pineconeClient, texts, metadatas, embeddings, textKey = "text", namespace = undefined) {
        const docs = [];
        ...
        return PineconeStore.fromDocuments(pineconeClient, docs, embeddings, textKey, namespace);
    }
