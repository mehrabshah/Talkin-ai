...
class WidgetBot extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement("div", { className: className, style: Object.assign(Object.assign({}, (0, elements_1.Root)({ width, height })), style) },
            React.createElement("iframe", { src: defer ? '' : this.state.url, ref: ref => (this.api.iframe = ref), style: elements_1.Embed, tabIndex: focusable ? null : -1, allow: "clipboard-write", title: "Discord chat embed" })));
    }
}
