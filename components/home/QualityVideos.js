        ...
        <div className="grid grid-cols-2 gap-4 items-center ">
          ...
          >
            <source
              ...
              src={
                "https://res.cloudinary.com/dvdxxna6v/video/upload/v1726973365/little_prince_video_pd8p1o.mp4"
              }
              type="video/mp4"
            />
          </video>
      ...
      <div className="max-w-full  md:hidden block mx-auto ">
        ...
        <div className="flex items-center flex-nowrap gap-5 overflow-x-auto px-5">
          ...
          >
            <source
              src={
                "https://res.cloudinary.com/dbospsdwo/video/upload/v1724030216/little_prince_and_the_rose_phpw5k.mp4"
              }
              type="video/mp4"
            />
          </video>
