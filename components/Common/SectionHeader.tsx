    ...
    <>
      ...
      >
        <div className="bg-zumthor dark:bg-blacksection dark:border dark:border-strokedark inline-block rounded-full py-1.5 px-4.5 mb-4">
          <h4 className="font-bold text-7xl  text-sectiontitle text-white ">
            {title}
          </h4>
        </div>
        <h2 className="font-bold text-3xl xl:text-sectiontitle3 text-white md:w-4/5 xl:w-1/2 mx-auto mb-4">
          {subtitle}
        </h2>
