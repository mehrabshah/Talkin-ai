...
var parse = __webpack_require__(9270);
...
// EXTERNAL MODULE: external "is-buffer"
var external_is_buffer_ = __webpack_require__(3715);
...
function buffer(value) {
  return external_is_buffer_(value)
}
...
var external_extend_ = __webpack_require__(950);
...
function base() {
  ...
  function processor() {
    ...
    destination.data(external_extend_(true, {}, namespace))
    ...
    function addPlugin(plugin, value) {
      ...
      if (entry) {
        if (isPlainObject(entry[1]) && isPlainObject(value)) {
          value = external_extend_(true, entry[1], value)
        }
...
function looksLikeAVFileValue(value) {
  return typeof value === 'string' || external_is_buffer_(value)
}
...
var react_is = __webpack_require__(2143);
...
var style_to_object = __webpack_require__(7848);
...
ReactMarkdown.propTypes = {
  // Core options:
  children: external_prop_types_.string,
  // Layout options:
  className: external_prop_types_.string,
  // Filter options:
  allowElement: external_prop_types_.func,
  allowedElements: external_prop_types_.arrayOf(external_prop_types_.string),
  disallowedElements: external_prop_types_.arrayOf(external_prop_types_.string),
  unwrapDisallowed: external_prop_types_.bool,
  // Plugin options:
  remarkPlugins: external_prop_types_.arrayOf(
    external_prop_types_.oneOfType([
      external_prop_types_.object,
      external_prop_types_.func,
      external_prop_types_.arrayOf(
        external_prop_types_.oneOfType([
          external_prop_types_.bool,
          external_prop_types_.string,
          external_prop_types_.object,
          external_prop_types_.func,
          external_prop_types_.arrayOf(
            // prettier-ignore
            // type-coverage:ignore-next-line
            external_prop_types_.any
          )
        ])
      )
    ])
  ),
  rehypePlugins: external_prop_types_.arrayOf(
    external_prop_types_.oneOfType([
      external_prop_types_.object,
      external_prop_types_.func,
      external_prop_types_.arrayOf(
  ...
  // Transform options:
  sourcePos: external_prop_types_.bool,
  rawSourcePos: external_prop_types_.bool,
  skipHtml: external_prop_types_.bool,
  includeElementIndex: external_prop_types_.bool,
  transformLinkUri: external_prop_types_.oneOfType([external_prop_types_.func, external_prop_types_.bool]),
  linkTarget: external_prop_types_.oneOfType([external_prop_types_.func, external_prop_types_.string]),
  transformImageUri: external_prop_types_.func,
  components: external_prop_types_.object
}
