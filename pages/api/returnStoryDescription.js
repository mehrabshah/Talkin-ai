      ...
      body: JSON.stringify({
        ...
        messages: [
          ...
          },
          {
            ...
            Each scene should have a distinct and clear setting. Try to begin each scene description with the character. One scene one row. Panel descriptor and summarization are unnecessary. No line spacing.",
            `,
          },
        ],
        max_tokens: 300,
