  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="create storyboard with AI, transform written scripts into images with character consistency"
        />
        <meta
          name="keywords"
          content="text to image ai,  text to image ai free,  ai storyteller, story telling ai "
        />
        ...
        <div className="relative pt-20 ml-auto">
          ...
          <div className="lg:w-2/3 text-center mx-auto">
            <h1 className="text-white dark:text-white font-bold text-5xl md:text-6xl xl:text-7xl">
              Story Board
              <span className="text-primary dark:text-white"> Generator.</span>
            </h1>
            <p className="mt-8 text-xl text-[#ccc5b9] dark:text-gray-300">
              Create Your Story Board in Seconds{" "}
            </p>
          </div>
        </div>
