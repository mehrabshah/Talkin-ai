    ...
    <>
      ...
      <div className="max-w-7xl w-full mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className={styles.topnav}>
          <div>
            <Link href="/">
              <h1 className="header1 text-2xl md:text-2xl font-bold">TALKIN.AI ChatBOT</h1>
            </Link>
          </div>
        ...
        <main className={styles.main}>
          ...
          <div className={styles.topnav}>
            <div>
              <Link href="/">
                <h1 className="header1 text-2xl md:text-2xl font-bold">Write a Review</h1>
              </Link>
            </div>
