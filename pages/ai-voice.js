      ...
      <div className="blur-[106px] h-30 bg-gradient-to-r from-orange-600 to-red-400 dark:from-red-700"></div>
        ...
        <div className="my-6 flex flex-col gap-4">
          <div className="flex gap-4 items-center text-white">
            ...
            <select ref={voiceRef} className="bg-[#5BBCFF] py-2 px-4 text-white rounded-lg">
              {voices.map((voice) => (
          ...
          <textarea
            className="text-black p-4 border border-blue-100 rounded-lg outline-none placeholder-gray-400 focus-within:drop-shadow-md"
            placeholder="Hello, very nice to meet you."
            cols={50}
            rows={10}
            ref={textRef}
          />
